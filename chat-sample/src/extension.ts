...
import { SummarizePrompt, CommentPrompt, CommentDetailedPrompt, CommentTersePrompt, FollowupQuestionsPrompt, GeneralECLQuestion } from "./play";
...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        eclagent,
        // Register the command handler for summarizing the file content
    ...
    context.subscriptions.push(
        eclagent,
        // Register the command handler for commenting the file content
    ...
    context.subscriptions.push(
        eclagent,
        // Register the command handler for reverting the file content
...
function getTopic(history: ReadonlyArray<vscode.ChatRequestTurn | vscode.ChatResponseTurn>): string {
    ...
    return topicsNoRepetition[Math.floor(Math.random() * topicsNoRepetition.length)] || "You have asked about all topics.";
}
